    ...
    <div className="max-w-7xl mx-auto space-y-6 text-white">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-zinc-400 text-sm mt-1">Every customer and property your org has worked on.</p>
        </div>
        {can('create:clients') && (
          ...
          {filtered.map(client => {
            ...
            return (
              <button
                ...
                className="bg-zinc-900 border border-zinc-800 rounded-lg p-4 text-left hover:border-zinc-600 hover:bg-zinc-800/60 transition-colors group"
              >
                <div className="flex items-start justify-between gap-2">
                  <p className="font-semibold text-white text-base leading-tight">{client.name}</p>
                  <ChevronRight size={16} className="text-zinc-600 group-hover:text-zinc-400 transition-colors shrink-0 mt-0.5" />
                </div>
